 ...
 *  Condiciones previas:
 *
 *	Crea una lista circular con "len" bolas a partir de "desde"
 *
 *  Bola *bombo   primer elemento del bombo
 *  int len       numero de bolas a introducir
 *  int desde	  primer numero a introducir
 *
 *  returns: void
 *
 *  Ejemplo:
 *  bombo_gen(bombo, 1, 90);
 *  mete en el bombo bolas desde la 1 hasta la 90
 *
 */
 ...
 *  Bola *bombo   primer elemento del bombo
 *
 *  returns: Numero de bolas que quedan en el bombo
 *
 *
 */
